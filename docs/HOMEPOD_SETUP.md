...
- [嘿助手](../嘿助手.shortcut)：日常对话入口，推荐绑定 Siri
...
2. 运行一次，确认能正常朗读返回结果
3. 再导入 [嘿助手](../嘿助手.shortcut)
4. 对 HomePod 说：`嘿 Siri, 运行嘿助手`
...
- 快捷指令名称：`嘿助手`（尽量用简短、独特、不会被 Siri 当成普通问句的名字）
- 点完成
...
| 问题 | 解决方案 |
|------|----------|
| Siri 自己回答了 | 换成更独特的名称，例如 `嘿助手`，并说："嘿 Siri, **运行**嘿助手" |
